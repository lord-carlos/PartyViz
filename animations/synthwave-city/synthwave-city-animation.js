...
export class SynthwaveCityAnimation {
  constructor(canvas, config) {
    ...
    this.colors = {
      ...
      fog: 0x1a1a3a,          // Lighter blue (originally 0x0a0a2a)
      ground: 0x0a0a0a,       // Dark gray
      grid: 0x16213e,         // Dark blue
      buildings: {
        tower: 0x2a2a4e,      // Dark blue with more blue tint
        block: 0x16314e,      // Dark blue with a greenish tint
        pyramid: 0x0f4470     // Dark blue with a stronger blue tint
      },
